...
const ui = computed(() =>
  lang.value === 'en'
    ? {
        ...
        featuredSubtitle: 'From building the AR dashboard end-to-end to ERP data integration and search behavior analytics, these projects showcase data development and business analysis practice.',
        skillsSubtitle: 'A three-dimensional capability structure of languages, tools and business skills.',
        projectsDesc: 'From building the ARDashboard AR management dashboard end-to-end (requirement alignment, data modeling, API development to visualization delivery), to ERP data integration & ETL modeling, to user behavior analysis in e-commerce and search scenarios - showcasing complete practice in data analysis, ERP integration and business insight.',
    ...
    : {
        ...
        featuredSubtitle: '从应收管理看板的完整搭建到 ERP 数据接入与搜索行为分析，多个代表性项目，展示数据开发与业务分析实践。',
        skillsSubtitle: '编程语言、工具框架与业务能力的三维能力结构。',
        projectsDesc: '从 ARDashboard 应收管理看板的完整搭建（需求口径梳理、数据建模、接口开发到可视化交付），到 ERP 数据接入与 ETL 建模，再到电商与搜索场景的用户行为分析，展示我在数据分析、ERP 对接与业务洞察上的完整实践。',
